...
desC includes a lightweight local default model:

- **LLM:** `qwen2.5-coder:0.5b-instruct`

> 🚀 **Small Model, Surprisingly Useful**
>
> desC is designed to make a very small local model practical and useful.
> By combining `qwen2.5-coder:0.5b-instruct` with project indexing, contextual RAG, and focused assistant modes, desC can provide helpful code and document assistance while staying lightweight.
>
> This means you can get useful local AI features without needing a large model or high-end hardware.
